...
let nansoffc = async (m, { conn, usedPrefix, command }) => {
    ...
    await conn.sendFile(m.chat, out, 'tovid.mp4', `Done ✅`, m, 0, { thumbnail: out })
}
nansoffc.help = ['tovideo']
nansoffc.tags = ['sticker']
nansoffc.command = ['tovideo','tomp4','tovid']
